...
# If Preprocessing of TRACERX data : input_data -> the path to TracerX.xlsx
input_data = "./Biological_Data/TRACERX_Data.xlsx"
cancer = 'LUSC'  # cancer type
IntOgen_file = './Biological_Data/IntOgen/IntOGen-DriverGenes_LUSC_TCGA.tsv'
...
# For TracerX
os.system("python ./lib/create_PairTree_input.py --input "
...
SampleInfo = pd.read_excel(input_dataset, sheet_name="TableS2", comment="#",
                           header=0)
SampleInfo = SampleInfo.loc[SampleInfo['Histology'] == cancer_description]
samples = SampleInfo.TRACERxID.unique().tolist()
# Read IntOgendata
